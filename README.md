...
> *Build the core. Automate the friction. Scale the system.*
...
#### 02 · Agentic AI Developer Tools
Custom CLI development agents and serverless automation workflows designed to streamline software engineering pipelines.

#### 03 · Tallyfy
An offline-first application engineered for local retail shopkeepers to track inventory, daily transactions, and customer credit offline seamlessly.
